...
module.exports = __webpack_require__(/*! /home/stoyan/Desktop/gitKraken-test/To-do-list/src/main.ts */"zUnb");
...
/* harmony import */ var _services_operations_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/operations.service */ "dO5I");
/* harmony import */ var _error_message_directive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./error-message.directive */ "wOlR");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        _services_operations_service__WEBPACK_IMPORTED_MODULE_6__["OperationsService"]
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _error_message_directive__WEBPACK_IMPORTED_MODULE_7__["ErrorMessageDirective"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _list_list_component__WEBPACK_IMPORTED_MODULE_4__["ListComponent"],
                    _error_message_directive__WEBPACK_IMPORTED_MODULE_7__["ErrorMessageDirective"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OperationsService, [{
...
/* harmony import */ var _services_operations_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/operations.service */ "dO5I");
...
function ListComponent_div_26_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_26_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const i_r4 = ctx.index; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.deleteTask(i_r4); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Delete");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "button", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_26_Template_button_click_9_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const i_r4 = ctx.index; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](14); return ctx_r7.editTask(i_r4, _r1); });
...
class ListComponent {
    ...
    ngOnInit() {
        ...
        if (this.isLocalStorage) {
            let isTasksAvailable = !!localStorage.getItem("taskList" /* taskList */);
            if (isTasksAvailable) {
                this.taskList = JSON.parse(localStorage.getItem("taskList" /* taskList */));
            }
            else {
                localStorage.setItem("taskList" /* taskList */, JSON.stringify([]));
            }
            this.trigger.addListener("reload" /* reload */, () => this.taskList = JSON.parse(localStorage.getItem("taskList" /* taskList */)));
        }
    }
    ngOnDestroy() {
        this.trigger.removeAllListeners;
    }
    changeElementView(elementId, displayState) {
        document.getElementById(elementId).style.display = displayState;
    }
    deleteTask(elementIndex) {
        this.service.deleteSingleTask(elementIndex);
        this.trigger.emit("reload" /* reload */);
    }
    editTask(elementIndex) {
        ...
        this.changeElementView("editForm" /* editForm */, 'block');
        this.changeElementView("createForm" /* createForm */, 'none');
    }
    changeTask(form) {
        if (form.invalid) {
            this.changeElementView("error-msg" /* errorMessage */, 'block');
            return;
        }
        let { id, newTitle, newDescription } = form.value;
        this.service.changeTaskValue(id, newTitle, newDescription);
        this.trigger.emit("reload" /* reload */);
        this.changeElementView("editForm" /* editForm */, 'none');
        this.changeElementView("createForm" /* createForm */, 'block');
        this.changeElementView("error-msg" /* errorMessage */, 'none');
    }
    createNewTask(form) {
        if (form.invalid) {
            console.log(form);
...
ListComponent.ɵfac = function ListComponent_Factory(t) { return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_operations_service__WEBPACK_IMPORTED_MODULE_2__["OperationsService"])); };
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-list"]], decls: 27, vars: 4, consts: [[1, "list-holder"], [1, "list"], ["id", "createForm", 3, "ngSubmit"], ["createForm", "ngForm"], ["ngModel", "", "required", "", "minlength", "3", "type", "text", "name", "taskTitle", "placeholder", "Task Title"], ["ngModel", "", "required", "", "minlength", "3", "name", "taskDescription", "placeholder", "Task description", "cols", "30", "rows", "10"], ["type", "submit"], ["id", "editForm", 1, "hidden", 3, "ngSubmit"], ["editForm", "ngForm"], ["required", "", "minlength", "3", "type", "text", "name", "newTitle", 3, "ngModel", "ngModelChange"], ["required", "", "minlength", "3", "name", "newDescription", "cols", "30", "rows", "10", 3, "ngModel", "ngModelChange"], ["type", "text", "name", "id", 1, "hidden", 3, "ngModel", "ngModelChange"], ["id", "error-msg", "hidden", "", 1, "error-msg"], [1, "task-holder"], [4, "ngFor", "ngForOf"], [1, "task-content"], [1, "btn-holder"], [3, "click"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ListComponent_Template_form_ngSubmit_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5); return ctx.createNewTask(_r0.form); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ListComponent_Template_form_ngSubmit_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](14); return ctx.changeTask(_r1.form); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_Template_input_ngModelChange_18_listener($event) { return ctx.editFormElementTitle = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "textarea", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_Template_textarea_ngModelChange_19_listener($event) { return ctx.editFormElementDescription = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](20, "input", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_Template_input_ngModelChange_20_listener($event) { return ctx.editFormElementId = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListComponent, [{
    ...
    }], function () { return [{ type: _services_operations_service__WEBPACK_IMPORTED_MODULE_2__["OperationsService"] }]; }, null); })();
...
ErrorMessageDirective.ɵfac = function ErrorMessageDirective_Factory(t) { return new (t || ErrorMessageDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])); };
ErrorMessageDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: ErrorMessageDirective, selectors: [["", "appErrorMessage", ""]], inputs: { isErrorMessage: "isErrorMessage" } });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ErrorMessageDirective, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
                selector: '[appErrorMessage]'
            }]
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] }]; }, { isErrorMessage: [{
